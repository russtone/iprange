...
func TestContains(t *testing.T) {
	tests := []struct {
		...
		// begin\end
		{[]string{"35.231.145.151\\35.231.150.10"}, "35.231.150.10", true},
		{[]string{"35.231.145.151\\35.231.150.10"}, "35.231.140.100", false},
		...
		// begin\end
		{[]string{"2001:db8::\\2001:db8::10"}, "2001:db8::5", true},
		{[]string{"2001:db8::\\2001:db8::10"}, "2001:db8::abab", false},
...
func TestCount(t *testing.T) {
	tests := []struct {
		...
		// begin\end
		{[]string{"35.231.145.151\\35.231.145.200"}, 50},
		...
		// begin\end
		{[]string{"2001:db8::\\2001:db8::10"}, 17},
